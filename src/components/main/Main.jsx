        ...
        <div className=''>
            <section className='flex justify-center '>
                <div className='flex flex-col justify-center items-center mt-20 border-y-2 w-[40%] max-md:w-[70%] py-10'>
                    ...
                    <h1 className='text-xl text-center mt-8'>This is where we tell you at all our <br />
            ...
            <section className='flex justify-center mt-56'>
                <div className='bg-[#7D75D8] relative rounded-lg w-[80%] max-xl:flex-col max-xl:items-center  flex justify-around'>
                    ...
                    <div className='text-white py-20 w-[50%] max-md:w-[80%] max-xl:mt-[40%] max-lg:mt-[50%] max-md:mt-[60%]'>
                        ...
                        <h1 className='text-xl py-6 pr-10'>Duis non orci justo. Nulla lobortis, elit ac  imperdiet mollis, nisi ante blandit ligula, vel  elementum urna velit eu lorem</h1>
                <button className=' bg-gradient-to-r from-[#6B60EB] to-[#CE5FE5] text-white flex gap-2 justify-center items-center px-10 py-4   text-xl font-bold rounded-xl '><h1>PUBLISH WORKS</h1> <img src={nextIcon} alt="" /></button>
            ...
            <section className='bg-slate-100 relative mt-48 pb-32'>
                <img className='absolute right-[10%] top-[-10%] max-lg:top-[-5%]' src={centerImg} alt="" />
                <div className='' >
                    ...
                    <div className='flex justify-center flex-wrap gap-10'>
                        <div className='bg-white w-[28%] max-xl:w-[48%] max-md:w-[70%] p-10'>
                            ...
                            <h1 className='font-serif text-4xl py-4'>Author Cohorts</h1>
                            <h1 className='text-xl'>Duis non orci justo. Nulla lobortis, elit ac i
                        ...
                        <div className='bg-white w-[28%] max-xl:w-[48%] max-md:w-[70%] p-10'>
                            ...
                            <h1 className='font-serif text-4xl py-4'>Early Access</h1>
                            <h1 className='text-xl'>Duis non orci justo. Nulla lobortis, elit ac i
                                mperdiet mollis, nisi ante blandit ligula, vel elem
                                entum urna velit eu lorem. Nullam in mauris sit amet quam
                                efficitur aliquam vel accumsan elit.</h1>
                            ...
                            <h1 className='font-serif text-4xl  py-4'>Platform Reader</h1>
                            <h1 className='text-xl'>Duis non orci justo. Nulla lobortis, elit ac i
                                mperdiet mollis, nisi ante blandit ligula, vel elem
                                entum urna velit eu lorem. Nullam in mauris sit amet quam
                                efficitur aliquam vel accumsan elit.</h1>
            ...
            <section className='flex justify-center py-20 bg-slate-50'>
                <div className='text-center'>
                    ...
                    <h1 className='text-xl text-[#303365] py-4'>Duis non orci justo. Nulla lobortis, elit ac imperdiet</h1>
                    <input className='w-[76%] p-2 rounded-md' type="text" placeholder='enter your email address here' />
                    <button className='rounded-md text-white px-6 py-2 bg-[#7D75D8]'>SEND</button>
                </div>
            </section>
            <footer className='bg-[#0E0F1E] py-16'>
                <div className='flex justify-around  text-xl  list-none max-lg:flex-col max-lg:gap-6 text-[#F6F6F6] max-lg:items-center'>
                    <div >
                        ...
                        <li className='max-lg:hidden'>© 2022 Alexandria Labs. All Right Reserved</li>
                    </div>
                    ...
                    <div className='flex justify-between flex-wrap gap-28 '>
                        <div>
                            <li className='mb-6'>About</li>
                            <li>Early Access</li>
                        </div>
                        <div>
                            <li className='mb-6'>Author Submissions</li>
                            <li>Team</li>
                        </div>
                        <div className=' max-lg:hidden'>
                            <li className='mb-6 flex gap-4'><img src={twitter} alt="" /> <h1 >  Twitter</h1></li>
                            <li className='flex gap-4'><img src={footerImg} alt="" /><h1>  Discord</h1></li>
                        </div>
                    </div>

                </div>
                    <li className='text-white text-xl lg:hidden  list-none text-center mt-32'>© 2022 Alexandria Labs. All Right Reserved</li>
            </footer>
        </div>
    )
}
